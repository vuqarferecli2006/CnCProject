...
public static class ServiceRegistration
{
    public static void RegisterServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IWriteAskedQuestionsRepository, AskedQuestionsRepository>();
        services.AddScoped<IReadAskedQuestionsRepository, AskedQuestionsRepository>();
        services.AddScoped<IBioReadRepository, BioRepository>();
        services.AddScoped<IBioWriteRepository, BioRepository>();
